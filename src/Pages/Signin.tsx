        ...
        <div className="flex w-full rounded-lg bg-gray-950 shadow-lg overflow-hidden">
          <div className="w-full p-8 sm:w-2/3">
            ...
            <p className="text-sm text-gray-100 mb-8">
              To use website, Please Login With Your Account.
            </p>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <input type="email" placeholder="Enter your email" className="mt-1 w-full p-2 bg-gray-950 text-white border border-gray-600 rounded" />
              </div>
